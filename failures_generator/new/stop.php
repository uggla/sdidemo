...
if ($_POST["btn"] == "Stop web service"){
	...
	if ($_POST["system"] == ""){
		print "Starting apache2 service on system ".$_POST["ip"]."<br/>\n";
	}
	else{
		print "Starting apache2 service on system ".$_POST["system"]."<br/>\n";
	}
		$cmd = '/usr/bin/ssh -i id_rsa -o StrictHostKeyChecking=no root@'. $_POST["ip"]. ' /etc/init.d/apache2 start';
	#print $cmd;
	#var_dump(shell_exec($cmd));
	shell_exec($cmd);
